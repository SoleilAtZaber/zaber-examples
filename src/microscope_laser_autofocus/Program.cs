    ...
    internal class Program
    {
        ...
        public void TestAutofocus()
        {
            ...
            using (var connection = Connection.OpenSerialPort(ZABER_PORT))
            {
                ...
                // Assuming that the user has done "make0" manually, autofocus
                AFOnce(curObjective)
        ...
        /// </summary>
        private static void Tracking(object source, ElapsedEventArgs e, Objective obj)
    {
        ...
        if (ecode == 0)
        {
            ...
            else if (Math.Abs(fpos) > 5 * obj.InFocusRange)
            {
        ...
        public bool AFOnce(Objective obj)
        {
            ...
            while  (Math.Abs(fpos) < obj.InFocusRange) // Do move rels until we converge
            {
                ...
                if (iter > 10) {
                    Console.WriteLine("Could not converge, check objective slope.");
                    return false;
                }
            }
            return true;
